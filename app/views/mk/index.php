      ...
      <ul class="list-group">
        <?php foreach ($data['mk'] as $mk) : ?>
          <li class="list-group-item">
            <?= $mk['nama']; ?>
            <a href="<?= BASEURL; ?>/mk/hapus/<?= $mk['id_mk']; ?>" class="badge badge-danger float-right" onclick="return confirm('yakin?');">hapus</a>
            <a href="<?= BASEURL; ?>/mk/ubah/<?= $mk['id_mk']; ?>" class="badge badge-success float-right tampilModalUbahMk" data-toggle="modal" data-target="#formModal" data-id="<?= $mk['id_mk']; ?>">ubah</a>
            <a href="<?= BASEURL; ?>/mk/detail/<?= $mk['id_mk']; ?>" class="badge badge-primary float-right">detail</a>
          </li>
        <?php endforeach; ?>
      </ul>
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabelMk">Tambah Data Matakuliah</h5>
